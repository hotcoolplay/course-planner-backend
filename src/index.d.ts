...
type programSubtype = 'Diploma' | 'Major' | 'Minor' | 'Option' | 'Specialization'
type requirementType = 'average' | 'breadth' | 'communication' | 'course' 
| 'depth' | 'pd' | 'term' | 'time' | 'unit' | 'work' | 'requirement'
